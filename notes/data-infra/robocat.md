...
- 本地 PDF：`papers/data-infra/RoboCat_Self_Improving_Robot_Agent_2306.11706.pdf`
...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| 自改进循环 | with vs without self-improvement | 自改进循环持续提升性能 |
| 跨本体训练 | multi vs single embodiment | 跨本体训练带来正迁移 |
| 视觉目标条件 | with vs without goal image | 目标图像条件对任务指定灵活 |
