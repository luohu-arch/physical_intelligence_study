...
- Local PDF: `/Users/luogu/physical_intelligence/papers/vla-reasoning/TriVLA_2507.01424.pdf`
...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| System 3 (视频扩散) | with vs without | 视频扩散作为情景世界模型提升长程规划 |
| 三系统 vs 双系统 | TriVLA vs GR00T N1 近似 | 三系统在 CALVIN 上超越双系统 |
| SVD 基座 | fine-tune SVD vs 从头训练 | 微调 SVD 比从头训练更数据高效 |

**核心结论**：增加视频扩散作为独立时序预测系统，从感知-动作升级为感知-预测-动作三阶段。
