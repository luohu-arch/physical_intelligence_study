...
- Local PDF: `/Users/luogu/physical_intelligence/papers/vla-architecture/MoS-VLA_2510.16617.pdf`
...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| 基函数数量 K | 不同 K 值 | K=16-32 覆盖技能空间 |
| L1 正则化强度 | 不同 lambda | L1 稀疏选择最适合的基函数组合 |
| One-shot vs few-shot | 1 vs 3 vs 5 demos | 1 次演示即可达到大部分增益 |

**核心结论**：基函数线性组合 + L1 凸优化使 one-shot 适配成为可能——数秒内得到适配权重。
