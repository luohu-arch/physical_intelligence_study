...
- 本地 PDF：`papers/reasoning/GR00T-N1_2503.14734.pdf`

- Local PDF: `/Users/luogu/physical_intelligence/papers/reasoning/GR00T-N1_2503.14734.pdf`
...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| 双系统 vs 单系统 | S2+S1 vs single | 双系统显著优于单系统 |
| 数据金字塔 | full pyramid vs 仅真实数据 | 仅 10% 真实数据即匹敌全量扩散策略 |
| Flow Matching 步数 | 4 vs 10 vs 16 | 4 步 Flow 在精度和速度间最优 |
| Action Horizon H | 16 vs 50 vs 8 | H=16 平衡时间一致性和反应速度 |

**核心结论**：数据金字塔是 GR00T N1 最关键的工程创新——大量仿真 + 少量真实数据。
