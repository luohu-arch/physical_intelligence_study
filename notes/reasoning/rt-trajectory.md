...
- 本地 PDF：`papers/reasoning/RT-Trajectory_Robotic_Task_Generalization_2311.01977.pdf`
...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| 轨迹 vs 语言条件 | 轨迹 vs 语言 vs 两者 | 轨迹条件在新任务泛化上远超语言（67% vs 11%） |
| 轨迹草图格式 | 2D 曲线 vs 关键点 vs 自然语言 | 粗粒度 2D 曲线最优 |
| 轨迹粒度 | 粗 vs 细 | 粗粒度轨迹足够，过细反而不利 |
