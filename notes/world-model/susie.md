...
| 消融因子 | 变化 | 结论 |
|---------|------|------|
| Pix2Pix fine-tune | with vs without robot data | 少量机器人数据 fine-tune 大幅提升子目标合理性 |
| 图像编辑 vs 视频生成 | SuSIE vs UniPi | 单帧子目标比视频规划更轻量 |
| 人类视频数据 | with vs without human video | 人类视频提供关键的视觉概念 |

**核心结论**：不需要生成整个视频，一帧子目标就够了——利用预训练扩散模型的视觉常识大幅降低世界模型训练成本。
